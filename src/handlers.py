...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    await update.message.reply_text(
        ...
        "• /nhanh — Nhập nhanh (gõ: <code>50000 cà phê</code>)\n\n"
        "📊 <b>BÁO CÁO</b>\n"
        ...
        "💳 <b>QUẢN LÝ NỢ</b>\n"
        "• /no — Ghi nợ, cho vay, đánh dấu đã trả\n\n"
        "🔁 <b>TỰ ĐỘNG</b>\n"
        "• /dinhky — Thiết lập chi tiêu định kỳ\n\n"
        "⚙️ <b>CÀI ĐẶT &amp; TIỆN ÍCH</b>\n"
        "• /caidat — Bật/tắt thông báo tự động\n"
        "• /xoa — Xóa giao dịch sai\n"
        "• /xuatfile — Xuất toàn bộ dữ liệu CSV\n"
        "• /huy — Hủy thao tác đang thực hiện\n"
        "━━━━━━━━━━━━━━━━━━\n"
        "💡 <b>Tip:</b> Gõ thẳng <code>50000 bún bò</code> để ghi nhanh không cần lệnh!",
        parse_mode="HTML"
    )
...
async def help_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    await update.message.reply_text(
        ...
        "━━━━━━━━━━━━━━━━━━\n"
        "💸 <b>GHI CHI TIÊU &amp; THU NHẬP</b>\n"
        "• /them → Chọn danh mục → Nhập tiền → Mô tả\n"
        "• /thunhap → Nhập tiền → Mô tả\n"
        "• Gõ thẳng <code>50000 bún bò</code> → Ghi vào danh mục Khác\n\n"
        "━━━━━━━━━━━━━━━━━━\n"
        "📊 <b>XEM BÁO CÁO</b>\n"
        "• /tomtat → Tổng quan tháng + biểu đồ danh mục\n"
        "• /hom_nay → Hạn mức ngày (tự cộng dư từ hôm trước)\n"
        "• /lichsu → 10 giao dịch gần nhất\n"
        "• /thongke → Chọn kỳ 7/30/90/365 ngày\n\n"
        "━━━━━━━━━━━━━━━━━━\n"
        "💰 <b>NGÂN SÁCH</b>\n"
        "• /nganquy → Đặt hạn mức cho từng danh mục\n"
        "• /nganquy_xem → Progress bar 🟢🟡🔴 từng danh mục\n"
        "• Cảnh báo tự động khi chi vượt 80% ngân sách\n\n"
        "━━━━━━━━━━━━━━━━━━\n"
        "🏦 <b>TIẾT KIỆM &amp; MỤC TIÊU</b>\n"
        "• /muctieu → Tạo mục tiêu (tên + số tiền + deadline)\n"
        "• /tietkiem → Ghi tiết kiệm, gắn vào mục tiêu cụ thể\n"
        "• Tự động hiện % tiến độ khi tiết kiệm\n\n"
        "━━━━━━━━━━━━━━━━━━\n"
        "💳 <b>QUẢN LÝ NỢ</b>\n"
        "• /no → Xem tổng quan nợ ròng\n"
        "  🔴 Ghi khoản tôi đang nợ người khác\n"
        "  🟢 Ghi khoản người khác nợ tôi\n"
        "  ✅ Đánh dấu đã thanh toán\n"
        "  🕐 Xem lịch sử đã trả\n\n"
        "━━━━━━━━━━━━━━━━━━\n"
        "🔁 <b>CHI TIÊU ĐỊNH KỲ</b>\n"
        "• /dinhky → Thiết lập giao dịch tự động hàng tháng\n"
        "• Bot tự ghi + thông báo đúng ngày đã đặt\n\n"
        "━━━━━━━━━━━━━━━━━━\n"
        "⚙️ <b>THÔNG BÁO TỰ ĐỘNG (/caidat)</b>\n"
        "• 🌅 Hàng ngày — tóm tắt chi tiêu + hạn mức\n"
        "• 📅 Hàng tuần — báo cáo thứ 2\n"
        "• 📊 Hàng tháng — tổng kết ngày 1\n"
        "• ⚠️ Cảnh báo vượt ngân sách realtime\n\n"
        "━━━━━━━━━━━━━━━━━━\n"
        "🗂️ <b>DANH MỤC CHI TIÊU</b>\n"
        "🍜 Ăn uống  🚗 Di chuyển  🛍️ Mua sắm\n"
        "🎮 Giải trí  💊 Y tế  📱 Hóa đơn\n"
        "📚 Giáo dục  🏦 Tiết kiệm  📦 Khác",
        parse_mode="HTML"
    )
